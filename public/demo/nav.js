...
(function () {
  var DEMOS = [
    ...
    { path: 'freeze-panes/index.html', label: '8. Freeze panes' },
    { path: 'statistics/index.html', label: '9. Statistics' },
    { path: 'summary-row/index.html', label: '10. Summary row' },
    { path: 'find-in-table/index.html', label: '11. Find in table' }
  ];
